<template>
  <div class="layout-content-block">
    ...
    <div class="section-content">
      ...
      <p>
        It uses a model-based solution for monitoring user input, this means all your validation rules can be put together in one place in your code,
      ...
      <p>
        This plugin strives to achieve both simplicity and flexibility for form validation, basic validation should require only the minimal amount of codes, at the same time, it should also support complex validation cases like:
      </p>
      <ul>
...
Vue.use(SimpleVueValidation);</code></pre>
  ...
  validators: { ... }
    ...
    <div class="section-title">Basic Example</div>
    <div class="section-content">
